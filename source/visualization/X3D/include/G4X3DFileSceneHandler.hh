...
#ifndef G4X3DFILE_SCENE_HANDLER_HH
#define G4X3DFILE_SCENE_HANDLER_HH
...
class G4X3DFileSceneHandler: public G4VSceneHandler {

  friend class G4X3DFileViewer;

// methods (public) 
public:
	G4X3DFileSceneHandler(G4X3DFile& system,
                              const G4String& name = "");
	virtual ~G4X3DFileSceneHandler();
...
private:
	...
	void closeFileStream();
        ...
        bool      SendTransformHeader();
        bool      SendTransformMarkerHeader(const G4VMarker&);
	...
	G4bool    isOpened         () { return fFlagDestOpen ; }
...
// data 
private:
	G4X3DFile& fSystem;	// Graphics system for this scene.

	G4String fX3DFileDestDir; 
	G4String fX3DFileName; 
	...
	// Note: these are not references, so after
        //       graphics system modifiction they are left untouched

	G4String  fX3DFileGreeting;
	G4String  fX3DFileClosing;  

	G4String  fX3DFileNamePrefix;
	G4String  fX3DFileNameExtension;
...
#endif //G4X3DFILE_SCENE_HANDLER_HH
